  ...
  return (
    <>
      <Column className="font-roboto items-center justify-start mx-[auto] w-[100%]">
        <Column className="bg-white_A701 justify-start lg:p-[18px] xl:p-[22px] 2xl:p-[25px] 3xl:p-[30px] w-[100%]">
          <Column className="justify-start 3xl:mb-[10px] lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] w-[15%]">
            <Img
              src="images/img_computer.svg"
              className="lg:h-[15px] xl:h-[18px] 2xl:h-[20px] 3xl:h-[24px] lg:w-[14px] xl:w-[17px] 2xl:w-[19px] 3xl:w-[23px]"
              alt="computer"
            />
            <Column className="justify-start lg:mt-[21px] xl:mt-[26px] 2xl:mt-[29px] 3xl:mt-[35px] w-[100%]">
              <Text
              ...
              <a
                ...
                target="_blank"
                className="font-normal xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[14px] lg:mt-[8px] not-italic xl:text-[10px] 2xl:text-[11px] 3xl:text-[14px] lg:text-[8px] text-lime_900 underline w-[auto]"
                rel="noreferrer"
              >
                See design guideline
              </a>
              <Text
                className="xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[14px] lg:mt-[8px] not-italic text-black_900 w-[auto]"
                variant="body3"
              >
        ...
        <List
          className="bg-white_A700 lg:gap-[14px] xl:gap-[17px] 2xl:gap-[19px] 3xl:gap-[23px] grid grid-cols-2 min-h-[auto] lg:p-[24px] xl:p-[30px] 2xl:p-[34px] 3xl:p-[41px] w-[100%]"
          orientation="horizontal"
        >
          <Column className="bg-white_A701 border border-bluegray_100 border-solid items-center justify-start 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[9px] rounded-radius16 w-[100%]">
            <Row className="bg-white_A701 items-start lg:pb-[14px] xl:pb-[17px] 2xl:pb-[19px] 3xl:pb-[23px] rounded-radius16 w-[100%]">
              <Column className="bg-white_A701 items-center justify-start 3xl:p-[11px] lg:p-[7px] xl:p-[8px] 2xl:p-[9px] rounded-radius16 w-[72%]">
                <Column className="items-center justify-start w-[100%]">
                  <Row className="items-start justify-between w-[100%]">
                    <Column className="bg-white_A701 items-center justify-start rounded-radius28 w-[36%]">
                      <Column className="justify-end p-[2px] w-[100%]">
                        <Text className="Header4" variant="body6">
                          Select time
                        </Text>
                      </Column>
                      <Column className="items-center justify-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[85%]">
                        <Row className="items-center justify-between w-[100%]">
                          <Row className="items-start justify-between w-[77%]">
                            <Button
                              className="font-normal not-italic lg:text-[20px] xl:text-[25px] 2xl:text-[28px] 3xl:text-[33px] text-center w-[44%]"
                          ...
                          <Column className="bg-white_A701 border border-gray_600 border-solid items-center rounded-radius8 w-[19%]">
                            <Button
                              className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[100%]"
                              size="md"
                              variant="OutlineGray600_3"
                            >
                              AM
                            </Button>
                            <Button
                              className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[100%]"
                              size="md"
                              variant="OutlineGray600_4"
                            >
                              PM
                            </Button>
                          </Column>
                        </Row>
                        <Column className="bg-gray_302 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] items-center justify-start lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                      ...
                      <Row className="items-start justify-between 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] lg:pb-[4px] 2xl:pb-[5px] xl:pb-[5px] 3xl:pb-[7px] lg:px-[4px] 2xl:px-[5px] xl:px-[5px] 3xl:px-[7px] w-[100%]">
                        <Stack className="lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] lg:mb-[2px] 2xl:mb-[3px] xl:mb-[3px] 3xl:mb-[4px] lg:px-[4px] 2xl:px-[5px] xl:px-[5px] 3xl:px-[7px] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                          <Img
                    ...
                    <Column className="bg-white_A701 items-center justify-start rounded-radius28 w-[62%]">
                      <Column className="justify-end p-[2px] w-[100%]">
                        <Text className="Header4" variant="body6">
                          Select time
                        </Text>
                      ...
                      <Row className="items-start justify-between w-[92%]">
                        <Column className="items-center justify-start lg:mt-[25px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[41%]">
                          ...
                          <Row className="bg-white_A701 border border-gray_600 border-solid items-center justify-evenly lg:mt-[5px] 2xl:mt-[7px] xl:mt-[7px] 3xl:mt-[9px] rounded-radius8 w-[100%]">
                            <Button
                              className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[50%]"
                              size="md"
                              variant="OutlineGray600_5"
                            >
                              AM
                            </Button>
                        ...
                        <Column className="bg-gray_302 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] items-center justify-start px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Column className="xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] items-center justify-start xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Row className="items-start w-[89%]">
                              <Stack className="lg:h-[31px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] lg:mt-[4px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] lg:w-[30px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px]">
                                <Column className="absolute lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] justify-start lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] right-[0] top-[0] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                      ...
                      <Row className="items-center justify-between lg:p-[4px] 2xl:p-[5px] xl:p-[5px] 3xl:p-[7px] w-[100%]">
                        <Stack className="lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] lg:my-[2px] 2xl:my-[3px] xl:my-[3px] 3xl:my-[4px] lg:px-[4px] 2xl:px-[5px] xl:px-[5px] 3xl:px-[7px] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                          <Img
                            src="images/img_calendar.svg"
                            className="calendar"
                            alt="calendar One"
                  ...
                  <Row className="items-start justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] w-[100%]">
                    <Column className="bg-white_A701 items-center justify-start rounded-radius28 w-[36%]">
                      ...
                      <Column className="items-center justify-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[78%]">
                        <Row className="items-start justify-between w-[100%]">
                          <Button
                            className="font-normal not-italic lg:text-[20px] xl:text-[25px] 2xl:text-[28px] 3xl:text-[33px] text-center w-[45%]"
                            shape="RoundedBorder8"
                            size="md"
                            variant="FillOrange101"
                          >
                        ...
                        <Stack className="bg-gray_302 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          ...
                          <Column className="absolute h-[max-content] inset-y-[0] justify-start left-[11%] my-[auto] lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                            <Text className="BuildingBlocks15" variant="body4">
                              21
                            </Text>
                          </Column>
                        </Stack>
                    ...
                    <Column className="bg-white_A701 items-center justify-start rounded-radius28 w-[62%]">
                      ...
                      <Row className="items-center justify-between w-[92%]">
                        ...
                        <Stack className="bg-gray_302 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] inset-[0] justify-center m-[auto] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                              <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
              ...
              <Column className="bg-white_A701 justify-start 3xl:p-[11px] lg:p-[7px] xl:p-[8px] 2xl:p-[9px] rounded-radius16 w-[28%]">
                <Column className="bg-white_A701 items-center justify-start rounded-radius28 w-[100%]">
                  ...
                  <Row className="items-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[85%]">
                    <Row className="items-start justify-between pb-[2px] w-[77%]">
                    ...
                    <Column className="bg-white_A701 border border-gray_600 border-solid items-center justify-start lg:ml-[4px] 2xl:ml-[5px] xl:ml-[5px] 3xl:ml-[7px] rounded-radius8 w-[19%]">
                      <Button
                        className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[100%]"
                        variant="OutlineGray600_3"
                      >
                ...
                <Column className="bg-white_A701 items-center justify-start lg:mt-[112px] xl:mt-[140px] 2xl:mt-[158px] 3xl:mt-[189px] rounded-radius28 w-[80%]">
                  <Column className="justify-end p-[2px] w-[100%]">
                    <Text className="Header4" variant="body6">
                      Enter time
                    </Text>
                  </Column>
                  <Row className="items-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] pb-[2px] w-[82%]">
                    <Column className="justify-start w-[44%]">
                      <Button
                        className="font-normal not-italic lg:text-[15px] xl:text-[19px] 2xl:text-[22px] 3xl:text-[26px] text-center w-[100%]"
                        shape="RoundedBorder8"
                    ...
                    <Text
                      className="lg:ml-[1px] 3xl:ml-[2px] 2xl:ml-[2px] xl:ml-[2px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] not-italic text-gray_900 w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                      :
                    </Text>
                    <Column className="justify-start lg:ml-[1px] 3xl:ml-[2px] 2xl:ml-[2px] xl:ml-[2px] w-[44%]">
                      <Button
                        className="font-normal not-italic lg:text-[15px] xl:text-[19px] 2xl:text-[22px] 3xl:text-[26px] text-center w-[100%]"
                        shape="RoundedBorder8"
                        variant="FillGray302"
                ...
                <Column className="items-center justify-start w-[100%]">
                  <Row className="items-start justify-between w-[100%]">
                    <Column className="bg-gray_900 items-center justify-start rounded-radius28 w-[36%]">
                      <Column className="justify-end p-[2px] w-[100%]">
                        <Text className="Header5" variant="body6">
                          Select time
                        </Text>
                      </Column>
                      <Column className="items-center justify-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[85%]">
                        <Row className="items-center justify-between w-[100%]">
                          ...
                          <Column className="bg-gray_900 border border-gray_500 border-solid items-center rounded-radius8 w-[19%]">
                            <Button
                              className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[100%]"
                              size="md"
                              variant="OutlineGray500_2"
                            >
                              AM
                            </Button>
                            <Column className="items-center justify-start lg:p-[3px] xl:p-[4px] 2xl:p-[5px] 3xl:p-[6px] w-[100%]">
                              <Text className="statelayer29" variant="body4">
                                PM
                              </Text>
                            </Column>
                          </Column>
                        </Row>
                        <Column className="bg-gray_801 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] items-center justify-start lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Column className="xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] items-center justify-start xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Row className="items-start w-[89%]">
                              <Stack className="lg:h-[31px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] lg:mt-[4px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] lg:w-[30px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px]">
                                <Column className="absolute lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] justify-start lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] right-[0] top-[0] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                            ...
                            <Row className="items-center justify-between mt-[2px] w-[100%]">
                              ...
                              <div className="bg-orange_300 border border-orange_300 border-solid lg:h-[3px] 2xl:h-[4px] xl:h-[4px] 3xl:h-[5px] rotate-[90deg] rounded-radius50 lg:w-[2px] 2xl:w-[3px] xl:w-[3px] 3xl:w-[4px]"></div>
                              <Column className="lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] items-center lg:px-[5px] xl:px-[6px] 2xl:px-[7px] 3xl:px-[8px] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                                <Text className="Content1" variant="body4">
                                  3
                                </Text>
                    ...
                    <Column className="bg-gray_900 items-center justify-start rounded-radius28 w-[62%]">
                      ...
                      <Row className="items-start justify-between w-[92%]">
                        <Column className="items-center justify-start lg:mt-[25px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[41%]">
                          ...
                          <Row className="bg-gray_900 border border-gray_500 border-solid items-center justify-evenly lg:mt-[5px] 2xl:mt-[7px] xl:mt-[7px] 3xl:mt-[9px] rounded-radius8 w-[100%]">
                            <Button
                              className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[50%]"
                              size="md"
                              variant="OutlineGray500_3"
                            >
                              AM
                            </Button>
                            <Column className="items-center lg:p-[3px] 2xl:p-[4px] xl:p-[4px] 3xl:p-[5px] w-[50%]">
                        ...
                        <Column className="bg-gray_801 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] items-center justify-start px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Column className="xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] items-center justify-start xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Row className="items-start w-[89%]">
                              <Stack className="lg:h-[31px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] lg:mt-[4px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] lg:w-[30px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px]">
                                <Column className="absolute lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] justify-start lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] right-[0] top-[0] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                  ...
                  <Row className="items-start justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] w-[100%]">
                    <Column className="bg-gray_900 items-center justify-start rounded-radius28 w-[36%]">
                      ...
                      <Column className="items-center justify-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[78%]">
                        ...
                        <Stack className="bg-gray_801 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] inset-[0] justify-center m-[auto] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                              <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                          ...
                                          <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                            <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                              ...
                                              <Column className="absolute justify-start right-[21%] top-[6%] w-[39%]">
                                                ...
                                                <div className="bg-orange_300 border border-orange_300 border-solid lg:h-[3px] 2xl:h-[4px] xl:h-[4px] 3xl:h-[5px] 3xl:ml-[11px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] rotate-[90deg] rounded-radius50 lg:w-[2px] 2xl:w-[3px] xl:w-[3px] 3xl:w-[4px]"></div>
                                              </Column>
                                            </Stack>
                                            <Column className="absolute lg:h-[17px] xl:h-[22px] 2xl:h-[24px] 3xl:h-[29px] items-center justify-start lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] right-[26%] top-[15%] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                                              <Text
                          ...
                          <Column className="absolute h-[max-content] inset-y-[0] justify-start left-[11%] my-[auto] lg:px-[4px] 2xl:px-[6px] xl:px-[6px] 3xl:px-[8px] lg:w-[16px] xl:w-[21px] 2xl:w-[23px] 3xl:w-[28px]">
                            <Text className="BuildingBlocks19" variant="body4">
                              21
                            </Text>
                          </Column>
                        </Stack>
                    ...
                    <Column className="bg-gray_900 items-center justify-start rounded-radius28 w-[62%]">
                      ...
                      <Row className="items-center justify-between w-[92%]">
                        ...
                        <Stack className="bg-gray_801 xl:h-[113px] 2xl:h-[127px] 3xl:h-[152px] lg:h-[90px] px-[2px] rounded-radius50 xl:w-[112px] 2xl:w-[126px] 3xl:w-[151px] lg:w-[89px]">
                          <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] inset-[0] justify-center m-[auto] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                            <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                              <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
                                <Stack className="absolute xl:h-[111px] 2xl:h-[125px] 3xl:h-[150px] lg:h-[89px] xl:w-[110px] 2xl:w-[124px] 3xl:w-[149px] lg:w-[88px]">
              ...
              <Column className="bg-gray_900 justify-start 3xl:p-[11px] lg:p-[7px] xl:p-[8px] 2xl:p-[9px] rounded-radius5 w-[28%]">
                  ...
                  <Row className="items-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[85%]">
                    <Row className="items-start justify-between pb-[2px] w-[77%]">
                      <Column className="justify-start w-[44%]">
                        ...
                        <Text className="Hour4" variant="body6">
                          Time label
                        </Text>
                      </Column>
                      <Text
                        className="lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] not-italic text-gray_300 w-[auto]"
                        as="h2"
                        variant="h2"
                      >
                        :
                    ...
                    <Column className="bg-gray_900 border border-gray_500 border-solid items-center justify-start lg:ml-[4px] 2xl:ml-[5px] xl:ml-[5px] 3xl:ml-[7px] rounded-radius8 w-[19%]">
                      <Button
                        className="font-medium lg:text-[5px] 2xl:text-[7px] xl:text-[7px] 3xl:text-[9px] text-center tracking-ls1 w-[100%]"
                        variant="OutlineGray500_2"
                      >
                ...
                <Column className="bg-gray_900 items-center justify-start lg:mt-[112px] xl:mt-[140px] 2xl:mt-[158px] 3xl:mt-[189px] rounded-radius28 w-[80%]">
                  ...
                  <Row className="items-start 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] pb-[2px] w-[82%]">
                    ...
                    <Text
                      className="lg:ml-[1px] 3xl:ml-[2px] 2xl:ml-[2px] xl:ml-[2px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] not-italic text-gray_300 w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                      :
