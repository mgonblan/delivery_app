          ...
          <Column className="justify-start lg:mb-[15px] xl:mb-[19px] 2xl:mb-[21px] 3xl:mb-[25px] w-[100%]">
            ...
            <Column className="justify-start lg:mt-[51px] xl:mt-[63px] 2xl:mt-[71px] 3xl:mt-[86px] w-[100%]">
              ...
              >
                ...
                and can be used to turn an option on or off. They’re a selection
                control that often appears when users are asked to pick a choice
                from options.
              </Text>
            </Column>
          </Column>
            ...
            <Column className="items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[23px] 3xl:p-[28px] rounded-radius5 w-[100%]">
              <Row className="items-center justify-between w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-lime_900_14 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-lime_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-lime_900_1e 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-lime_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] rounded-radius50 file">
                  <Stack className="bg-lime_900_1e rounded-radius50 computer4">
                    <div className="absolute bg-lime_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
              ...
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Img src="images/img_file.svg" className="file" alt="file" />
                <Img
              ...
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] computer4">
                    <div className="absolute bg-red_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
                      alt="checkmark Five"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-red_900_14 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-red_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-red_900_1e 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-red_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] rounded-radius50 file">
                  <Stack className="bg-red_900_1e rounded-radius50 computer4">
                    <div className="absolute bg-red_900 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark.svg"
                      className="checkmark"
          ...
          <Column className="bg-gray_900 items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[23px] 3xl:p-[28px] rounded-radius16 w-[100%]">
            <Column className="bg-gray_900 items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[23px] 3xl:p-[28px] rounded-radius5 w-[100%]">
              <Row className="items-center justify-between w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-orange_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-gray_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-orange_300_14 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-orange_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_1.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-orange_300_1e 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-orange_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_1.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-orange_300_1e rounded-radius50 computer4">
                    <div className="absolute bg-orange_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_1.svg"
                      className="checkmark"
              ...
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-orange_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_iconscheckind_gray_902.svg"
                      className="checkmark"
                      alt="Iconscheckind One"
                    />
                  </Stack>
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-gray_300 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_iconscheckind_gray_900.svg"
                      className="checkmark"
              ...
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                ...
                <Img
                  ...
                  alt="computer Three"
                />
                <Img src="images/img_save.svg" className="file" alt="save" />
              </Row>
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-deep_orange_200_14 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-deep_orange_200 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_3.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-deep_orange_200_1e 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-deep_orange_200 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_3.svg"
                      className="checkmark"
                ...
                <Column className="items-center px-[4px] file">
                  <Stack className="bg-deep_orange_200_1e rounded-radius50 computer4">
                    <div className="absolute bg-deep_orange_200 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_checkmark_3.svg"
                      className="checkmark"
              ...
              <Row className="items-center justify-between lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="items-center px-[4px] file">
                  <Stack className="3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius50 computer4">
                    <div className="absolute bg-deep_orange_200 lg:h-[16px] xl:h-[20px] 2xl:h-[22px] 3xl:h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 lg:w-[15px] xl:w-[19px] 2xl:w-[21px] 3xl:w-[25px]"></div>
                    <Img
                      src="images/img_iconscheckind_pink_900.svg"
                      className="checkmark"
